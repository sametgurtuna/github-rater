...
export default function ProfileHeader({ user }: ProfileHeaderProps) {
  ...
  return (
    <motion.div 
      className="bg-gray-800/50 p-8 rounded-xl border border-gray-700 glass-scrollbar"
    ...
    >
      <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
        ...
        >
          ...
          {user.hireable && (
            <motion.div 
              className="mt-4 inline-flex items-center gap-2 px-3 py-1 bg-green-500/20 border border-green-500/30 rounded-full text-green-400 text-sm"
